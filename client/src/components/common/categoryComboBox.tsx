...
function CategoryComboBoxMovies({
  ...
  const sorts = [
    ...
    { value: "4", label: `${t("genre.advergames")}` },
    { value: "5", label: `${t("genre.animation")}` },
    { value: "6", label: `${t("genre.arcade")}` },
    { value: "7", label: `${t("genre.adventure")}` },
    { value: "8", label: `${t("genre.action")}` },
    { value: "9", label: `${t("genre.basedOnRealLife")}` },
    { value: "10", label: `${t("genre.battleRoyale")}` },
    { value: "11", label: `${t("genre.beatEmUp")}` },
    { value: "12", label: `${t("genre.cards")}` },
    { value: "13", label: `${t("genre.casual")}` },
