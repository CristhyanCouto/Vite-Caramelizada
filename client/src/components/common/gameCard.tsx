            ...
            >
              ...
              <div className="text-1xl">
                {props.singleplayer === true ? (
                  <p className="text-center">{t("games.singlePlayer")}</p>
                ) : null}
                {props.multiplayer === true ? (
                  <p className="text-center">{t("games.multiPlayer")}</p>
                ) : null}
                {props.multiplayer_local === true ? (
                  <p className="text-center">{t("games.multiplayerLocal")}</p>
                ) : null}
              </div>
            </div>
          </div>
