...
export function PlataformBackground({ plataform }: PlataformBackgroundProps) {
    return (
      <div className="text-white text-5xl">
        ...
        "><SiPlaystation4  /></div>}
        {plataform === 7 && <div className="bg-red-500 rounded-full w-20 h-20 shadow flex justify-center items-center align-center text-center
        "><FaXbox  /> 360</div>}
        {plataform === 8 && <div className="bg-red-500 rounded-full w-20 h-20 shadow flex justify-center items-center align-center text-center
        "><FaXbox  /> One</div>}
