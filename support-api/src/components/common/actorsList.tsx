...
export default function ActorsList({ refreshComponentCounter }: ActorsListProps) {
    ...
    <div>
      <ScrollArea className="h-[700px] w-[450px] rounded-md border p-4 bg-white">
        <div className="p-4">
          ...
          <h1 className="text-2xl font-bold text-center my-4">Actors</h1>
                ...
                .filter((value) => {
                  return (
                    (value.first_name &&
                      value.first_name
                        .toLowerCase()
                        .includes(searchActors.toLowerCase())) ||
                    (value.last_name &&
                      value.last_name
                        .toLowerCase()
                        .includes(searchActors.toLowerCase())) ||
